...
cap = cv2.VideoCapture('/media/imsahil/Windows/Users/ImSahil/Downloads/Friends Season 3 Complete 720p.BRrip.Sujaidr (pimprg)/friends.s03e01.720p.bluray.sujaidr.mkv')
conf_t = 0.97
while cap.isOpened(): 
    ...
    for res in results:
      ...
      print("Number of faces found {}",format(len(results)))
